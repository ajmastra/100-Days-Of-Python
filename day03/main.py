...
if direction.lower() == "left":
    action = input("You come to a lake. Do you want to swim or wait for a boat? ")

    if action.lower() == "wait":
        door = input("You arrive at an island with three doors: red, yellow, and blue. Which door do you choose? ")
